    ...
    <div className="p-8 h-full overflow-auto space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Day-Ahead vs Real-Time pricing trends and volatility.</p>
        </div>
        <div className="flex gap-4">
          <Select value={node} onValueChange={setNode}>
            ...
            <SelectContent>
              <SelectItem value="HB_HOUSTON">HB_HOUSTON</SelectItem>
              <SelectItem value="HB_NORTH">HB_NORTH</SelectItem>
              <SelectItem value="HB_SOUTH">HB_SOUTH</SelectItem>
              <SelectItem value="HB_WEST">HB_WEST</SelectItem>
              <SelectItem value="LZ_HOUSTON">LZ_HOUSTON</SelectItem>
              <SelectItem value="LZ_SOUTH">LZ_SOUTH</SelectItem>
            </SelectContent>
          </Select>
